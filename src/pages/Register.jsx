      ...
      >
        <form onSubmit={handleSubmit} className="absolute inset-[2px] rounded-[8px] bg-gray-100 dark:bg-[#28292d] z-[10] flex flex-col py-[50px] px-[40px]">
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input className="peer" name="floating_text" type="text" placeholder=" " required onChange={(e)=>setName(e.target.value)}/>
            <label htmlFor="floating_text">First Name</label>
          </div>
          <div className="relative z-0 w-full mb-6 group">
            <input className="peer" name="floating_text" type="text" placeholder=" " required onChange={(e)=>setLastName(e.target.value)}/>
